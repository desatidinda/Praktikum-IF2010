...
public class KeyValuePairGeneric<K, V> implements Pair<K, V> {
    ...
    public String getTypeKeyandValue() {
        ...
        return String.format("%s memiliki tipe %s dan value dari key tersebut memiliki tipe %s dengan nilai berupa %s", key, key.getClass().getSimpleName(), value.getClass().getSimpleName(), value);
    }
}