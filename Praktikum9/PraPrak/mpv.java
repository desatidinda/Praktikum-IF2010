...
public class mpv { 
    ...
    public static class Video {
        ...
        public boolean hasSubtitle(String language) {
            ...
            Subtitle checkSubtitle = new Subtitle(language);
            return subtitles.contains(checkSubtitle);
        }
        ...
        public List<String> getAvailableLanguages() {
            ...
            for (Subtitle subtitle : subtitles) {
                languages.add(subtitle.getLanguage());
            }
            return languages;
        }
    }
    ...
    public void addVideo(String title, String filename, int durationSeconds)
        ...
        if (filename == null || (!filename.endsWith(".mp4") && !filename.endsWith(".mkv") && !filename.endsWith(".avi"))) {
        ...
        for (Video video : videoDatabase.values()) {
            if (video.getFilename().equals(filename.toLowerCase())) {
    ...
    public List<Video> getVideosByFormat(String format) {
        ...
        for (Video video : videoDatabase.values()) {
            if (video.getFilename().toLowerCase().endsWith(formatted)) {
                result.add(video);
            }
        }
        return result;
