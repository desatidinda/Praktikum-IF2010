 ...
 * Bacteria.java
 * 
 * Kelas abstrak yang mengimplementasikan BacteriaBehaviuor.
...
public abstract class Bacteria implements BacteriaBehaviour {
    ...
    public void reproduce(int days, double effectiveModifier) {
        setCurrentPopulation(currentPopulation + (int)(currentPopulation * days * growthRate * effectiveModifier));
    }
