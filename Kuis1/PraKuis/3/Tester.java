public class Tester {
    public static void main(String[] args) {
        ...
        // Tes change blog
        Blog oldBlog = new Blog("Purry ingin bercocok tanam!", "WOWWWWW!!!");
        Blog newBlog = new Blog("Purry gagal panen!", "Astaga naga...");
        DanvilleNews.changePost(oldBlog, newBlog);

        // Tes change video
        Video oldVideo = new Video("1000 singa Vs 1000 kura-kura siapa yang akan menang?!", "videogacor.mp4", 283);
        Video newVideo = new Video("1000 singa Vs 1000 kuda nil siapa yang menang?!", "videobaru.mp4", 310);
        TuanBinatang.changePost(oldVideo, newVideo);
        ...
        System.out.println("\n-- Notifikasi User1 setelah blog diganti --");
        String[] notifUser1After = user1.getNotifications();
        for (int i = 0; i < user1.getNotificationCount(); i++) {
            System.out.println(notifUser1After[i]);
        }

        System.out.println("\n-- Notifikasi User2 setelah video diganti --");
        String[] notifUser2After = user2.getNotifications();
        for (int i = 0; i < user2.getNotificationCount(); i++) {
            System.out.println(notifUser2After[i]);
        }
