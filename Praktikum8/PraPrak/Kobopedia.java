...
public class Kobopedia {
    public static class Barang {
        ...
        private String nama;
        private int harga;
        Map<String, Integer> ratingPengguna;
        ...
        public double getRating() {
            ...
            return (double) total / ratingPengguna.size();
        }
    }
    ...
    public static class BarangSorter implements Comparator<Barang> {
        ...
        public BarangSorter(String attribute) {
            if (attribute.equals("harga") || attribute.equals("rating") || attribute.equals("id")) {  //kalo sesuai brrti sortir sesuai itu
